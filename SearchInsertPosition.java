...
I do not think that this is O(log n) runtime complexity, but I reduced the array size by
initially splitting the array in half for the starting index if it was less than 
 */
...
public class SearchInsertPosition {
    ...
    public static int insertionIndex(int[] numbers, int target){
        ...
        while(numbers[index] < target && index < numbers.length){
            index += index/2;
        }
